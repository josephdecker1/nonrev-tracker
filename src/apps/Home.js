      ...
      <div css={ css` background: url(https://image.businessinsider.com/5db803d8dee01914e3699423?width=1100&format=jpeg&auto=webp) center 80%;
          ...
          <div class="ui center aligned container">
            ...
            <div class="ui divided three column grid">
              <div class="row">
                <div class="column">
                  <i aria-hidden="true" class="red paper plane huge icon"></i>
                ...
                <div class="column">
                  <i aria-hidden="true" class="red calendar check huge icon"></i>
                ...
                <div class="column">
                  <i aria-hidden="true" class="red trophy huge icon"></i>
